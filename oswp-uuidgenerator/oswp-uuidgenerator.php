<?php
/**
 * WordPress Widget oswp-uuidgenerator
 *
 * 
 *
 * @package   Widget_oswp-uuidgenerator
 ...
 * Domain Path:       /lang
 * GitHub Plugin URI: https://github.com/BigManzai/oswp-uuidgenerator
 */
...
// TODO: change 'oswp_uuidgenerator' to the name of your plugin
class oswp_uuidgenerator extends WP_Widget {

    /**
     * @TODO - Rename "oswp-uuidgenerator" to the name your your widget
     *
     ...
     * @var      string
     */
    protected $widget_slug = 'oswp-uuidgenerator';
	...
	public function __construct() {
		...
		parent::__construct(
			...
			__( 'oswp-uuidgenerator', $this->get_widget_slug() ),
			array(
	...
	public function widget( $args, $instance ) {
		...
		ob_start();
		include( plugin_dir_path( __FILE__ ) . 'views/uuidgenerator-widget.php' );
...
/* 		register_setting( 'oswp-widget-settings-group', 'oswptitle' );
	...
	public function widget_textdomain() {
		...
		// TODO be sure to change 'oswp-uuidgenerator' to the name of *your* plugin
